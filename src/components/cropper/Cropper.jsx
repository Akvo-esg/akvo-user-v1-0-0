                ...
                <div className="col-12 d-flex justify-content-center">
                    <div >
                        <div>
                            ...
                            <label htmlFor="inputButton" className="akvo_btn akvo_btn_primary btn-sm akvo_form_control mb-1 text-wrap">Alterar Imagem</label>
                        </div>
                        <div>
                            {selectFile &&

                                <button type="button" className="akvo_btn akvo_btn_secondary btn-sm akvo_form_control" data-bs-toggle="modal" data-bs-target="#cropperModal">
                                    Editar imagem
                                </button>
                            }
