...
export default function FontesEstacionariasDeCombustao(props) {
    ...
    const handleEditDB = async () => {
        ...
        if (isValid) {
            ...
            const emissoes = calc(editCombustivelIdDB, editConsumoAnualDB, props.data.fonteEmissao, props.fatoresEmissao, props.tipoCalculo)
                                                        ...
                                                        <tr className="fadeItem" key={`edit${index}`}>
                                                            ...
                                                            <td scopo="row">
                                                                <select className="form-select form-select-sm"
                                                                    ...
                                                                    <option value="11,Biodiesel(B100),litros">Biodiesel (B100)</option>
                                                                    <option value="10,Etanol,litros">Etanol</option>
                                                                    <option value="5,Gás Liquefeito de Petróleo (GLP),kg">Gás Liquefeito de Petróleo (GLP)</option>
                                                                    <option value="4,Gás Natural Veicular (GNV),m³">Gás Natural Veicular (GNV)</option>
                                                                    <option value="1,Gasolina Automotiva (comercial),litros">Gasolina Automotiva (comercial)</option>
                                                                    <option value="2,Óleo Diesel (comercial),litros">Óleo Diesel (comercial)</option>
                                                                </select>
                                                            </td>
                                                            <td scopo="row">
