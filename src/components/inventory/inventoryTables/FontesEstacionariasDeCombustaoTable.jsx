...
export default function FontesEstacionariasDeCombustaoTable(props) {
    ...
    const handleEditDB = async () => {
        ...
        if (isValid) {
            ...
            const emissoes = calc(editCombustivelDB, editQtdDB, props.data.unidSetorPrimario, props.data.fonteEmissao, props.fatoresEmissao)
        ...
        if (inventoryList.length > 0) {
            return (
                <div className="fadeItem">
                    <h6 className="h5_title">Últimos dados cadastrados na unidade {props.data.unidName} / {props.data.anoInventario}</h6>
