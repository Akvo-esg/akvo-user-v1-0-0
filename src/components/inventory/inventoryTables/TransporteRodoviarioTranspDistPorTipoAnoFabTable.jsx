...
export default function TransporteRodoviarioTranspDistPorTipoAnoFabTable(props) {
    ...
    const renderInventoryTable = (list) => {
        ...
        for (let i = 0; i < list.length; i++) {
            if (list[i].fonteEmissao === "Transporte e Distribuição" &&
            ...
            } else if (list[i].fonteEmissao === "Transporte e Distribuição" &&
                list[i].tipoEmissao === "Transporte Rodoviário" &&
                list[i].tipoCalculo === "Por tipo e ano de fabricacao" &&
                list[i].unid_id === props.data.unid_id &&
                list[i].anoInventario === props.data.anoInventario &&
                    ...
                    <div className="table-responsive">
                        <small>
                            <table className="table table-striped table-sm ">
                                <thead>
                                    <tr>
                                        <th className="text-center akvo-text-escopo3">Código</th>
                                        {showMore ?
                                            <>
                                                <th>
                                            ...
                                            :
                                            <>
                                                <th className="text-center akvo-text-escopo3">Identificador</th>
                                                <th className="text-center akvo-text-escopo3">Descrição da fonte</th>
                                            </>
                                        }
                                        <th className="text-center akvo-text-escopo3">Tipo da frota de veículos</th>
                                        <th className="text-center akvo-text-escopo3">Ano da frota</th>
                                        <th className="text-center akvo-text-escopo3">Período de consumo</th>
                                        <th className="text-center akvo-text-escopo3 fadeItem">Consumo anual</th>
                                        <th className="text-center akvo-text-escopo3">Emissões fósseis totais<br />t CO<sub>2</sub> eq.</th>
                                        <th className="text-center akvo-text-escopo3">Emissões biogênicas<br />t CO<sub>2</sub></th>
                                        {showMoreInfo && (
                                            <>
                                                <th className="text-center akvo-text-escopo3">Emissões t CO<sub>2</sub><br />(Combustíveis fóssies)</th>
                                                <th className="text-center akvo-text-escopo3">Emissões t CH<sub>4</sub><br />(Combustíveis fóssies)</th>
                                                <th className="text-center akvo-text-escopo3">Emissões t N<sub>2</sub>O<br />(Combustíveis fóssies)</th>
                                                <th className="text-center akvo-text-escopo3">Emissões t CO<sub>2</sub><br />(Biocombustíveis)</th>
                                                <th className="text-center akvo-text-escopo3">Emissões t CH<sub>4</sub><br />(Biocombustíveis)</th>
                                                <th className="text-center akvo-text-escopo3">Emissões t N<sub>2</sub>O<br />(Biocombustíveis)</th>
                                                <th className="text-center akvo-text-escopo3">Usuário</th>
                                                <th className="text-center akvo-text-escopo3">Data de cadastro/Atualização</th>
                                            </>
                                        )}
                                        <th className="text-center akvo-text-escopo3"></th>
