...
export default function EnergiaEletricaSINTable(props) {
    ...
    const renderInventoryTable = (list) => {
        ...
        for (let i = 0; i < list.length; i++) {
            if (list[i].fonteEmissao === "Energia elétrica - Sem escolha de compra" &&
            ...
            } else if (list[i].fonteEmissao === "Energia elétrica - Sem escolha de compra" &&
                list[i].tipoEmissao === "Sistema Interligado Nacional (SIN)" &&
                list[i].unid_id === props.data.unid_id &&
                list[i].anoInventario === props.data.anoInventario &&
                showMore) {
                    ...
                    <div className="table-responsive">
                        <small>
                            ...
                            <table className="table table-striped table-sm ">
                                <thead>
                                    <tr>
                                        <th className="text-center akvo-text-escopo2">Código</th>
                                        {showMore && !editCodeDB ?
                                            <>
                                                <th>
                                            ...
                                            <>
                                                ...
                                                <th className="text-center akvo-text-escopo2">Descrição da fonte</th>
                                            </>
                                        }
                                        ...
                                        <th className="text-center akvo-text-escopo2">Emissões fósseis totais<br />t CO<sub>2</sub> eq.</th>
                                        <th className="text-center akvo-text-escopo2">Emissões biogênicas<br />t CO<sub>2</sub></th>
                                        {showMoreInfo && (
                                            <>
                                                <th className="text-center akvo-text-escopo2">Emissões t CO<sub>2</sub><br />(Combustíveis fóssies)</th>
                                                <th className="text-center akvo-text-escopo2">Emissões t CH<sub>4</sub><br />(Combustíveis fóssies)</th>
                                                <th className="text-center akvo-text-escopo2">Emissões t N<sub>2</sub>O<br />(Combustíveis fóssies)</th>
                                                <th className="text-center akvo-text-escopo2">Emissões t CO<sub>2</sub><br />(Biocombustíveis)</th>
                                                <th className="text-center akvo-text-escopo2">Emissões t CH<sub>4</sub><br />(Biocombustíveis)</th>
                                                <th className="text-center akvo-text-escopo2">Emissões t N<sub>2</sub>O<br />(Biocombustíveis)</th>
                                                <th className="text-center akvo-text-escopo2">Usuário</th>
                                                <th className="text-center akvo-text-escopo2">Data de cadastro/Atualização</th>
                                            </>
                                        )}
