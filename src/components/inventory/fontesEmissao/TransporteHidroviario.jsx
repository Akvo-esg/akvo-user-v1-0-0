            ...
            <tr>
              ...
              <td>
                ...
                >
                  ...
                  <option value="1,Litros,Gasolina automotiva (comercial)">
                    Gasolina automotiva (comercial)
                  </option>
                  <option value="9,Litros,Óleo Combustível">
                    Óleo Combustível
                  </option>
                  <option value="3,Litros,Óleo Diesel (puro)">
                    Óleo Diesel (puro)
                  </option>
                </select>
              </td>
                        ...
                        <tr key={`edit${index}`}>
                          ...
                          <td scopo="row">
                            ...
                            >
                              ...
                              <option value="31,Litros,Gasolina automotiva (comercial)">
                                Gasolina automotiva (comercial)
                              </option>
                              <option value="41,Litros,Óleo Combustível">
                                Óleo Combustível
                              </option>
                              <option value="44,Litros,Óleo Diesel (puro)">
                                Óleo Diesel (puro)
                              </option>
                            </select>
                          </td>
