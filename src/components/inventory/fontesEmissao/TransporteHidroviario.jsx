...
export default function TransporteHidroviario() {
	...
	const handleSubmit = () => {
        ...
        console.log('Handle Submit', combustivelId, consumoAnual, states.fonteEmissao, fatoresEmissao);  
						...
						<tr>
							...
							<td>
								<select
                                    ...
                                    <option value="1,Litros,Gasolina automotiva (comercial)" >Gasolina automotiva (comercial)</option>
                                    <option value="9,Litros,Óleo Combustível" >Óleo Combustível</option>
                                    <option value="3,Litros,Óleo Diesel (puro)" >Óleo Diesel (puro)</option>
								</select>
							</td>
							<td>
								<select
