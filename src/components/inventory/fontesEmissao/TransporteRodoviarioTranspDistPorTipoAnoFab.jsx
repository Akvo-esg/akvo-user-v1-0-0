...
export default function FontesEstacionariasDeCombustao(props) {
    ...
    const handleSubmit = () => {
        ...
        if (isValid) {
            const emissoes = calc(tipoFrotaId, anoFrota, consumoAnual, "Transportes", props.fatoresEmissao, props.tipoCalculo)
                ...
                <table className="table table-striped table-sm fadeItem">
                    <thead>
                        <tr className="py-2">
                            ...
                            <th className="text-center akvo-text-escopo3">Descrição da frota</th>
                    ...
                    <tbody>
                        {list.map((elem, index) => {
                            ...
                            if (elem.fonteEmissao === "Transporte e Distribuição" &&
