export function calc(tipoFrotaId, anoFrota, consumoAnual, fonteEmissao, fatoresEmissao, tipoCalculo) {
    ...
    const fatoresEmissaoTipoCalculo = fatoresEmissaoList.find(elem => elem.tipoCalculo === tipoCalculo)
    ...
    const emissoesCH4_F = consumoAnual * fatoresCombustivel.CH4 / 1000
    const emissoesN2O_F = consumoAnual * fatoresCombustivel.N2O / 1000
